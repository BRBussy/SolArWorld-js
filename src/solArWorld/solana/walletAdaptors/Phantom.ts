...
export class PhantomWalletClient implements WalletAdapter {
    _provider: PhantomWalletClient | undefined;
    ...
    connect = async () => {
        ...
        let provider: PhantomWalletClient;
